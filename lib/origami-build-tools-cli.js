...
function printUsage(commands) {
	...
	console.log('   [--demoConfig=<path>]   Path to the demos config file. (default: demos/src/config.json)');
	...
	console.log('   [--buildFolder=<file>]  Compiled assets directory (default: ./build/)');

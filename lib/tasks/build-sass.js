 ...
 * @return {String} - The sass from the file, with extra Sass variables and prefixes according to configuration.
 */
 ...
 * @param {Boolean} config.sourcemaps [true] - Whether to include inline sourcemaps (defaults to `false` when `production` is `true`).
 * @param {Boolean} config.production [false] - Whether this is a production build. Non-production builds do not minify CSS and include sourcemaps by default.
 ...
 * @param {*} config.ignoreBower - True to include npm Sass paths, otherwise bower paths are used.

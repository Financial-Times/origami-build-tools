...
module.exports = function(gulp, config) {
	...
	if (configPath) {
		...
		if (!Array.isArray(demosConfig.demos)) {
			...
			log.primary('Copy and paste this config into origami.json, or run origami-build-tools');
			log.primary('with --updateorigami to update origami.json with the new config format.');

				...
				return readFile(origamiJsonPath, 'utf8')
					.then(file => {
						...
						if (componentDemos) {
							...
							const hasNoTitle = componentDemos.some(function (demo) {
								return ! Object.prototype.hasOwnProperty.call(demo, 'title');
							});
							if (hasNoTitle) {
								result.push('All demos require a title property.');
							}
						}

...
module.exports = function(gulp, config) {
	...
	module.exports.addEditorConfig(gulp, config);
	module.exports.addJsHintRc(gulp, config);
};
...
module.exports.addEditorConfig = function(gulp, config) {
	var config = config || {};
	if (config.editorconfig) {
		log.primary('.editorconfig added');
		gulp.src(__dirname + '/../../config/.editorconfig')
			.pipe(gulp.dest('./'));
	}
};

module.exports.addJsHintRc = function(gulp, config) {
	var config = config || {};
	if (config.jshintrc) {
		log.primary('.jshintrc added');
		gulp.src(__dirname + '/../../config/jshint.json')

				...
				commandLine.run('gem', ['install', 'sass', '-v', versions.sass])
					.then(function() {
						...
						getCommandVersion('ruby', '--version')
							.then(function(version) {
								if (version === -1) {
									log.secondary('You need to install Ruby.  Please consult the Origami developer guide if you need help: http://origami.ft.com/docs/developer-guide/building-modules/#install-ruby');
								}
							}, function(error) {

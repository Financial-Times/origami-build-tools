...
exports.local = function(configPath, callback) {
    log.primary("Build demos for local development");
    buildDemos(configPath, "local", callback);
};

exports.buildService = function(configPath, callback) {
    log.primary("Build demos for build service");
    buildDemos(configPath, "buildservice", callback);
};
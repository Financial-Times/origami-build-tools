...
function getDemoWarning(staticSource) {
    ...
    if (staticSource === "local") {
        var html = [
            '<style>',
            '.demo-message { position: absolute; left:0 ; right: 0; bottom: 0; border-top: 1px solid #ddcc66; padding: 3px; font-family: Arial, Helvetica, sans-serif; font-size: 12px; text-align: center; background-color: #ffee88; color: #333; }',
            '</style>',

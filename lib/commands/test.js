...
function testSilentCompile(callback) {
    var mainCss = files.getBuildFolderPath() + '/main.css',
        sassVars = {};
    sassVars[bowerJson.name + '-is-silent'] = true;
    var sassFile = fs.readFileSync(process.cwd() + '/main.scss', 'utf8');
    sass.compileWithVars(sassFile, mainCss, sassVars, { style: 'compressed', loadPaths: ['.'] }, function() {
...
function testNonSilentCompile(callback) {
    ...
    var sassFile = fs.readFileSync(process.cwd() + '/main.scss', 'utf8');
    sass.compileWithVars(sassFile, nonSilentCss, sassVars, { style: 'compressed', loadPaths: ['.'] }, function() {

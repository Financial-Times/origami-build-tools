        ...
        function(callback) {
            if (files.bowerJsonExists()) {
                ...
                var bowerCommand = getBowerCommand(function(err, command) {
					...
					var configContainsOrigamiRegistry = Array.isArray(registrySearchConfig) && ((registrySearchConfig.indexOf("http://registry.origami.ft.com") > 0) ||
						(registrySearchConfig.indexOf("https://registry.origami.ft.com") > 0) ||
						(registrySearchConfig.indexOf("registry.origami.ft.com")));
					...
					if (!configContainsOrigamiRegistry) {
						...
						callback("Check Origami registry configuration in bowerrc");
					}

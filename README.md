...
* __eslint(gulp, config)__ Config accepts:
	- eslintPath: `String` Path to your custom eslint config file. (Default: 'origami-build-tools/config/eslint.json' _This may be set for product development, but developers of Origami-compliant components are required to accept the default_
